(() => {
  ...
  const cardIllustrations = new Map([
    ...
    ["avatar-of-the-grove", { icon: "🌳", gradient: ["#8bc34a", "#2e7d32"], accent: "#e9ffe6" }],
    ["elder-dryad", { icon: "🧙‍♀️", gradient: ["#b5e48c", "#52734d"], accent: "#f0fff4" }],
    ["forest-guardian", { icon: "🛡️" }],
    ["druid-of-the-grove", { icon: "🌿" }],
